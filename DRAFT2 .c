...
void inverse();
void cc1();
//*void cc1 added to remove redundancy and improve flow for main
void cc1() 
//char array define size
{
	char message[100], ch;
	int i, key = 0;


	//*asks for encrypted string
	printf("What is your encrypted text?");
//stores string as message
	gets(message);
	//*ask for key
	printf("What is your key?");
//stores integer data as key
	scanf_s("%d", &key);
//key formula for Ceaser
// sourced  from 
//www.thecrazyprogrammer.com/2016/11/caesar-cipher-c-c-encryption-decryption.html
	{
...
//cesar is case 1
	{
		{case 1:
			cc1();
			//*cesar formula moved from int main to void
			return 0;
		}
